...
block vectorOrPoint:
  ...
  doAssert examplePoint == examplePoint.toPoint
  doAssert exampleVector == exampleVector.toVector
...
block createColorFromTuple:
  let c = initColor(-0.5, 0.4, 1.7)
  doAssert c.red == -0.5
  doAssert c.green == 0.4
  doAssert c.blue == 1.7

block colorOperations:
  let
  ...
  doAssert c1 + c2 == initColor(1.6, 0.7, 1.0)
  doAssert c1 - c2 == initColor(0.2, 0.5, 0.5)
  doAssert c3 * 2.0 == initColor(0.4, 0.6, 0.8)
  doAssert c4 * c5 == initColor(0.9, 0.2, 0.04)
